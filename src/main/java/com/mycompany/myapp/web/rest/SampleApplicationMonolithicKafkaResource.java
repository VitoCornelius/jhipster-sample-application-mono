...
@RestController
@RequestMapping("/api/sample-application-monolithic-kafka")
public class SampleApplicationMonolithicKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SampleApplicationMonolithicKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SampleApplicationMonolithicKafkaResource(KafkaProperties kafkaProperties) {
