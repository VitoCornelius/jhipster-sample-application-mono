...
class SampleApplicationMonolithicKafkaResourceIT {
    ...
    void setup() {
        ...
        SampleApplicationMonolithicKafkaResource kafkaResource = new SampleApplicationMonolithicKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/sample-application-monolithic-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/sample-application-monolithic-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
